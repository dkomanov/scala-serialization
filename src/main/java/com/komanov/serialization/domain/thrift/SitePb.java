...
public class SitePb implements org.apache.thrift.TBase<SitePb, SitePb._Fields>, java.io.Serializable, Cloneable, Comparable<SitePb> {
  ...
  private _Fields optionals[] = {_Fields.ID,_Fields.OWNER_ID,_Fields.REVISION,_Fields.SITE_TYPE,_Fields.FLAGS,_Fields.NAME,_Fields.DESCRIPTION,_Fields.DOMAINS,_Fields.DEFAULT_META_TAGS,_Fields.PAGES,_Fields.ENTRY_POINTS,_Fields.PUBLISHED,_Fields.DATE_CREATED,_Fields.DATE_UPDATED};
...
;
  ...
  public SitePb setOwnerId(byte[] ownerId) {
    setOwnerId(ownerId == null ? (ByteBuffer)null : ByteBuffer.wrap(ownerId));
    return this;
  }
        ...
        switch (schemeField.id) {
          ...
          case 4: // SITE_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.siteType = SiteTypePb.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  SiteFlagPb _elem18;
                  _elem18 = SiteFlagPb.findByValue(iprot.readI32());
                  struct.flags.add(_elem18);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  DomainPb _elem21;
                  _elem21 = new DomainPb();
                  _elem21.read(iprot);
                  struct.domains.add(_elem21);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  MetaTagPb _elem24;
                  _elem24 = new MetaTagPb();
                  _elem24.read(iprot);
                  struct.defaultMetaTags.add(_elem24);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  EntryPointPb _elem30;
                  _elem30 = new EntryPointPb();
                  _elem30.read(iprot);
                  struct.entryPoints.add(_elem30);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(4)) {
        {
          ...
          {
            SiteFlagPb _elem43;
            _elem43 = SiteFlagPb.findByValue(iprot.readI32());
      ...
      if (incoming.get(7)) {
        {
          ...
          {
            DomainPb _elem46;
            _elem46 = new DomainPb();
            _elem46.read(iprot);
            struct.domains.add(_elem46);
          }
        }
        struct.setDomainsIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          {
            MetaTagPb _elem49;
            _elem49 = new MetaTagPb();
            _elem49.read(iprot);
            struct.defaultMetaTags.add(_elem49);
          }
        }
        struct.setDefaultMetaTagsIsSet(true);
      }
      ...
      if (incoming.get(10)) {
        {
          ...
          {
            EntryPointPb _elem55;
            _elem55 = new EntryPointPb();
            _elem55.read(iprot);
            struct.entryPoints.add(_elem55);
          }
        }
        struct.setEntryPointsIsSet(true);
      }
