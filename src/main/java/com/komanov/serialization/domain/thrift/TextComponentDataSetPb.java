...
public class TextComponentDataSetPb implements org.apache.thrift.TBase<TextComponentDataSetPb, TextComponentDataSetPb._Fields>, java.io.Serializable, Cloneable, Comparable<TextComponentDataSetPb> {
  ...
  static {
    schemes.put(StandardScheme.class, new TextComponentDataSetPbStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TextComponentDataSetPbTupleSchemeFactory());
  }
  ...
  private _Fields optionals[] = {_Fields.ID,_Fields.TEXT};
...
;
  ...
  public TextComponentDataSetPb setId(ByteBuffer id) {
    this.id = id;
    return this;
  }
  ...
  public TextComponentDataSetPb setText(String text) {
    this.text = text;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TextComponentDataSetPb(");
    boolean first = true;
  ...
  private static class TextComponentDataSetPbStandardSchemeFactory implements SchemeFactory {
    public TextComponentDataSetPbStandardScheme getScheme() {
      return new TextComponentDataSetPbStandardScheme();
    }
  }

  private static class TextComponentDataSetPbStandardScheme extends StandardScheme<TextComponentDataSetPb> {
  ...
  private static class TextComponentDataSetPbTupleSchemeFactory implements SchemeFactory {
    public TextComponentDataSetPbTupleScheme getScheme() {
      return new TextComponentDataSetPbTupleScheme();
    }
  }

  private static class TextComponentDataSetPbTupleScheme extends TupleScheme<TextComponentDataSetPb> {
