...
public class PagePb implements org.apache.thrift.TBase<PagePb, PagePb._Fields>, java.io.Serializable, Cloneable, Comparable<PagePb> {
  ...
  private _Fields optionals[] = {_Fields.NAME,_Fields.PATH,_Fields.META_TAGS,_Fields.COMPONENTS};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  MetaTagPb _elem2;
                  _elem2 = new MetaTagPb();
                  _elem2.read(iprot);
                  struct.metaTags.add(_elem2);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  PageComponentPb _elem5;
                  _elem5 = new PageComponentPb();
                  _elem5.read(iprot);
                  struct.components.add(_elem5);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(2)) {
        {
          ...
          {
            MetaTagPb _elem12;
            _elem12 = new MetaTagPb();
            _elem12.read(iprot);
            struct.metaTags.add(_elem12);
          }
        }
        struct.setMetaTagsIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          {
            PageComponentPb _elem15;
            _elem15 = new PageComponentPb();
            _elem15.read(iprot);
            struct.components.add(_elem15);
          }
        }
        struct.setComponentsIsSet(true);
      }
