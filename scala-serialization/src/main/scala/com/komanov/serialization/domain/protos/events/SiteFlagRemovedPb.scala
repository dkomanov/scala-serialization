...
@SerialVersionUID(0L)
final case class SiteFlagRemovedPb(
    ...
    def mergeFrom(__input: com.google.protobuf.CodedInputStream): com.komanov.serialization.domain.protos.events.SiteFlagRemovedPb = {
      ...
      com.komanov.serialization.domain.protos.events.SiteFlagRemovedPb(
          siteFlag = __siteFlag
      )
    }
    def withSiteFlag(__v: com.komanov.serialization.domain.protos.site.SiteFlagPb): SiteFlagRemovedPb = copy(siteFlag = __v)
    ...
    def companion = com.komanov.serialization.domain.protos.events.SiteFlagRemovedPb
}

object SiteFlagRemovedPb extends com.trueaccord.scalapb.GeneratedMessageCompanion[SiteFlagRemovedPb] {
  implicit def messageCompanion: com.trueaccord.scalapb.GeneratedMessageCompanion[SiteFlagRemovedPb] = this
  def fromFieldsMap(__fieldsMap: Map[com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.komanov.serialization.domain.protos.events.SiteFlagRemovedPb = {
  ...
  lazy val defaultInstance = com.komanov.serialization.domain.protos.events.SiteFlagRemovedPb(
  )
  implicit class SiteFlagRemovedPbLens[UpperPB](_l: com.trueaccord.lenses.Lens[UpperPB, SiteFlagRemovedPb]) extends com.trueaccord.lenses.ObjectLens[UpperPB, SiteFlagRemovedPb](_l) {
